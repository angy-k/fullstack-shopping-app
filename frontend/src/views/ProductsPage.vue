    ...
    <div class="filters">
      <div class="filter-group">
        <v-select
          ...
          density="compact"
          hide-details
          @update:model-value="handleFilterChange('category', filters.category)"
        ></v-select>
      </div>
      ...
      <div class="price-range-group md-col-3">
        ...
        <div class="price-inputs">
          <v-text-field
            ...
            placeholder="Min"
            class="price-input"
            @update:model-value="handleFilterChange('minPrice', filters.minPrice)"
          ></v-text-field>
          ...
          <v-text-field
            ...
            placeholder="Max"
            class="price-input"
            @update:model-value="handleFilterChange('maxPrice', filters.maxPrice)"
          ></v-text-field>
        </div>
      </div>
      ...
      <div class="filter-group min-stock-filter">
        <v-text-field
          ...
          density="compact"
          variant="outlined"
          @update:model-value="handleFilterChange('minStock', filters.minStock)"
        ></v-text-field>
      </div>
